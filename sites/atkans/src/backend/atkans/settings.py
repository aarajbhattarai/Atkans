...
class Base(StyleguideMixin, DRFMixin, RichieCoursesConfigurationMixin, Configuration):
    ...
    * DB_PORT
    ...
    SECRET_KEY = "zesrxdtcyvubinoibiuvtcyrta3s4d5f6g765yxtzr34tx5yc6uvy5uv6b7b"  # nosec
    ...
    ROOT_URLCONF = "atkans.urls"
    WSGI_APPLICATION = "atkans.wsgi.application"
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": values.Value(
                "atkans", environ_name="DB_NAME", environ_prefix=None
            ),
...
class Production(Base):
    ...
    AWS_S3_REGION_NAME = values.Value("ap-south-1")

    AWS_MEDIA_BUCKET_NAME = values.Value("production-atkans-media")
    AWS_IS_GZIPPED=True

    # Change AWS S3 domain so we can serve the media from a different domain using a CDN
    AWS_S3_CUSTOM_DOMAIN = 'atkans.com'
